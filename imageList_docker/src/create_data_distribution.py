...
leaf_map = json.loads(open("../input_images/plantvillage_deeplearning_paper_dataset/leaf-map.json", "r").read())
OUTPUT_FOLDER = "../input_images/plantvillage_deeplearning_paper_dataset/lmdb"
